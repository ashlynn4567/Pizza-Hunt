...
request
    ...
    (nonexistant to version 1, v1 to v2, and etc.) */
    ...
    .onsuccess = function(event) {
        /* when db is successfully created with its object store (from oneupgradeneeded event 
        above) or simply established a connection, save reference to db in global variable */
